...
options:
  ...
  path:
    description:
      ...
      - Can be set to auto to set the default link
    required: true
  link:
    description:
...
def main():
    ...
    if path == 'auto' and not is_auto:
        if module.check_mode:
            module.exit_json(changed=True, is_auto=is_auto)
        else:
            try:
                module.run_command(
